...
- A Handled account ([sign up here](https://app.handled.one))
- An API token from the dashboard

## Step 1: Get Your API Token

1. Log into your [Handled dashboard](https://app.handled.one)
...
```
https://app.handled.one/connect-account?link_token=abc123-def456-ghi789
```
